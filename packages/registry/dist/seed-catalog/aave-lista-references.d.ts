...
export declare const AAVE_V3_BNB_ROLES: ProtocolRoleReference[];
export declare const LISTA_DAO_BNB_ROLES: ProtocolRoleReference[];
/** All documented BNB role references (review-only; no addresses included). */
export declare const BNB_PROTOCOL_ROLE_REFERENCES: ProtocolRoleReference[];
//# sourceMappingURL=aave-lista-references.d.ts.map