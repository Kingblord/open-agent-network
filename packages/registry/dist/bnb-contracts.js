...
export const PANCAKE_ROUTER_FUNCTIONS = [
    {
...
export const VENUS_COMPTROLLER_FUNCTIONS = [
    {
...
export const VENUS_ORACLE_FUNCTIONS = [
    {
...
export const VTOKEN_READ_FUNCTIONS = [
    {
...
export const VTOKEN_EXECUTE_FUNCTIONS = [
    {
...
const AAVE_POOL_READ_FUNCTIONS = [
    {
 ...
 */
export const BNB_MAINNET_CONTRACTS = [
    {
 ...
 */
export const BNB_MAINNET_ABI_SEEDS = [
    {
        address: PANCAKE_SWAP_ROUTER,
        chainId: 56,
        functions: [
